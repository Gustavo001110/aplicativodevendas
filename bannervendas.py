...
class BannerVendas(GridLayout):
    ...
    def __init__(self, **kwargs):
        ...
        direita_label_preco = Label(text= f"Preco: R${preco}", size_hint=(1, 0.33) , pos_hint={"right": 1, "top": 0.65})
        direita_label_quantidade = Label(text=f"{quantidade} {unidade}", size_hint=(1, 0.33) , pos_hint={"right": 1,
                                                                                                         "top": 0.4})
